                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="product_img">
                                    @if(count($product->photoes()->get())>0)
                                    ...
                                    @else
                                    <a href="{{ asset('/').'category/'.$product->Category()->first()->name.'/'.$product->name.'/'.$product->id }}"><img style="height:210px" src="{{ asset('/assets/images/gallery_item_small12.jpg')}}" alt="product_img1"></a>
                                    @endif
